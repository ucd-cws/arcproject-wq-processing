...
$destination = "C:\Users\dsx\Code\arcproject-wq-processing\distribution.zip"
If(Test-Path $destination) {Remove-Item $destination}

# Make the wheel and copy files to the distribution folder
& "C:\Python27\ArcGIS10.5\python" .\setup.py bdist_wheel
...
$source = "C:\Users\dsx\Code\arcproject-wq-processing\distribution"
